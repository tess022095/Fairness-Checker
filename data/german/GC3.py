...
# print(permutation_importance("boosting", data_orig_train_1, data_orig_test_1, "sex", "DID"))
# print(permutation_importance("boosting", data_orig_train_1, data_orig_test_1, "sex", "EOD"))
# print(permutation_importance("boosting", data_orig_train_1, data_orig_test_1, "sex", "EOR"))
#
# print(permutation_importance("boosting", data_orig_train_2, data_orig_test_2, "sex", "DIR"))
# print(permutation_importance("boosting", data_orig_train_2, data_orig_test_2, "sex", "DID"))
# print(permutation_importance("boosting", data_orig_train_2, data_orig_test_2, "sex", "EOD"))
# print(permutation_importance("boosting", data_orig_train_2, data_orig_test_2, "sex", "EOR"))
