...
model_1 = SVC(random_state=42,probability=True).fit(X_train_1, y_train_1)

# model_2 = GridSearchCV(svc_clf, param_grid=y1_params)
# model_2.fit(X_train_2, y_train_1)
# model_2 = model_2.best_estimator_
model_2 = SVC(random_state=42,probability=True).fit(X_train_2, y_train_2)
...
# print(permutation_importance("SVC", data_orig_train_1, data_orig_test_1, "sex", "DIR"))
# print(permutation_importance("SVC", data_orig_train_1, data_orig_test_1, "sex", "DID"))
# print(permutation_importance("SVC", data_orig_train_1, data_orig_test_1, "sex", "EOD"))
# print(permutation_importance("SVC", data_orig_train_1, data_orig_test_1, "sex", "EOR"))
#
# print(permutation_importance("SVC", data_orig_train_2, data_orig_test_2, "sex", "DIR"))
# print(permutation_importance("SVC", data_orig_train_2, data_orig_test_2, "sex", "DID"))'number_of_credits', 'credit_amount', 'status'
# print(permutation_importance("SVC", data_orig_train_2, data_orig_test_2, "sex", "EOD"))'number_of_credits'
# print(permutation_importance("SVC", data_orig_train_2, data_orig_test_2, "sex", "EOR"))
