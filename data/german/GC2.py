...
eval_set_y1=[(X_train_2, y_train_2), (X_test_2, y_test_2)]
eval_set_y2=[(X_train_1, y_train_1), (X_test_1, y_test_1)]
...
model_1 = XGBClassifier(**params2)
model_1 = model_1.fit(X_train_1, y_train_1)

model_2 = XGBClassifier(**params2)
