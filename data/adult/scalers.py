...
reamining_cat_feat = []
good_data_orig, X_full, y_full = load_adult_data(df_good, pro_att_name, priv_class, reamining_cat_feat)
dataset, attr = good_data_orig.convert_to_dataframe()

# dataset = fetch_california_housing()
# X_full, y_full = dataset.data, dataset.target
feature_names = good_data_orig.feature_names
print(feature_names)
feature_mapping = {
    "age": "Age",
    "hours-per-week": "Edu",
